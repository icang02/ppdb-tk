...
@section('main-content')
    <div class="card">
        ...
        <div class="card-body">
            <a href="{{ route('auth_non_akademik_create') }}" class="btn btn-primary mb-4">Tambah Data</a>
